    ...
    <div class="large-container">
        ...
        <form autocomplete="off" method="post" accept-charset="utf-8" id="registrationForm" onsubmit="return validation();">
            ...
            <div class="sign-up-box" style="text-align: center; margin-top: 20px;">
                <h4 style="margin-bottom: 10px; font-size: 16px; font-weight: bold; color: #333;">Already have an account?</h4>
                <a href="login.php" style="color: #007bff; text-decoration: none; font-size: 14px; font-weight: bold;">
                    Log In
                </a>
            </div>
        </div>
