...
<head>
    ...
    <title>Rabbiroots - Product Details</title>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                    <div class="content-box ml_20">
                                        <h2 style="font-size: 25px;">Garden Fresh apple in the best price</h2>
                                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit facilisi diam, primis
                                            dapibus sapien conubia augue enim feugiat. Conubia sem gravida sapien velit
                                            suscipit platea class</p>
                                        ...
                                        <div class="addto-cart-box mb_45">
                                            <ul class="clearfix">
                                                ...
                                                <li><a href="ShopDetails.html"><i class="icon-5"></i></a></li>
                                        ...
                                        <div class="payment-option mb_30">
                                            ...
                                            <ul class="card-list">
                                                <li><a href="ShopDetails.html"><img
                                        ...
                                        <ul class="other-option clearfix">
                                            ...
                                            <li><strong>Tag :</strong><a href="ShopDetails.html">Best sellers</a>, <a
                                                    href="ShopDetails.html">New Arrivals</a>, <a
                                                    href="ShopDetails.html">On Sale</a></li>
                                            <li class="social-links"><strong>Share :</strong><a
                                                    href="ShopDetails.html"><i class="icon-13"></i></a><a
                                                    href="ShopDetails.html"><i class="icon-14"></i></a><a
                                                    href="ShopDetails.html"><i class="icon-15"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
