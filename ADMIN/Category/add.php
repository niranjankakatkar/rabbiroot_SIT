...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if($url_id=="")
	{
		...
		$sql="INSERT INTO category(category_title,description,filepath,flag,prep_by) VALUES('$category_title','$description','$uploadPath','$flag','$prep_by')";
        ...
        if($conn->query($sql))
		{
		 ?>		  
		  ...
		  window.location.href="../Category/"; </script>
		  <?php
		}
	}else{
       ...
       if($conn->query($sql))
        {
            ?>
			    ...
			    <script>  alert('Category Update Successfully'); window.location.href="../Category/"; </script>
		    <?php
        }
	}										
                             ...
                             <div class="card">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        <div class="col">                      
                                            <h4 class="card-title">Add/Edit Category Form</h4>                      
                                        </div><!--end col-->
                                    </div>  <!--end row-->                                  
                                </div><!--end card-header-->
                                <div class="card-body pt-0">
                                    <form  method="POST" class="form" enctype="multipart/form-data"  autocomplete="off">
                                        <div class="mb-2">
                                            <label for="username" class="form-label">Category Title</label>
                                            <input class="form-control" type="text" name="category_title" id="category_title" value="<?=givedata($conn,"category","id",$url_id,"category_title");?>" placeholder="Enter Category Title" required>
                                           
                                        </div>
                                        <div class="mb-2">
                                            <label for="email" class="form-label">Description</label>
                                           <input class="form-control" type="text" name="description" id="description" value="<?=givedata($conn,"category","id",$url_id,"description");?>" placeholder="Enter Category Description" required>
                                           
                                        </div>
										<div class="mb-2">
                                            <label for="email" class="form-label">Category Image<span class="text-muted"> (*Upload your blog image here, Please click "Upload Image" Button)</span></label>
                                           <div class="input-group">
                                            ...
                                            ?>
											<input class="form-control" type="hidden" name="filepath" id="filepath" value="<?=givedata($conn,"category","id",$url_id,"filepath");?>" >
