...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if($url_id=="")
	{
		$sql="INSERT INTO attributes(attribute_type_id,attribute_title,description,flag,prep_by) VALUES('$attribute_type_id','$attribute_title','$description','$flag','$prep_by')";
		if($conn->query($sql))
		{
		 ?>		  
		  <script>
		  window.location.href="../Attribute/"; </script>
		  <?php
		}
	}else{
		$sql="UPDATE attributes set attribute_type_id='$attribute_type_id',attribute_title='$attribute_title',description='$description',flag='$flag' where id='$url_id'";
		
       if($conn->query($sql))
        {
            ?>
			    <script> window.location.href="../Attribute/"; </script>
		    <?php
        }
	}										
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        <div class="col">                      
                                            <h4 class="card-title">Add/Edit Attribute Form</h4>                      
                                        </div><!--end col-->
                                    </div>  <!--end row-->                                  
                                </div><!--end card-header-->
                                <div class="card-body pt-0">
									<form  method="POST" class="form" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-2">
                                            <label for="username" class="form-label">Attribute Title</label>
                                            <input class="form-control" type="text" name="attribute_title" id="attribute_title" value="<?=givedata($conn,"attributes","id",$url_id,"attribute_title");?>" placeholder="Enter Attribute Title" required>
                                           
                                        </div>
                                        <div class="mb-2">
                                            <label for="email" class="form-label">Description</label>
                                           <input class="form-control" type="text" name="description" id="description" value="<?=givedata($conn,"attributes","id",$url_id,"description");?>" placeholder="Enter Attribute Description" required>
