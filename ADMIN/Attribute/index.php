...
if($Dflag!=""){
	...
	$sql = "DELETE FROM attribute WHERE id='$url_id'";
	if($conn->query($sql)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
													    <p class="d-inline-block align-middle mb-0">
                                                            <a href="ecommerce-order-details.html" class="d-inline-block align-middle mb-0 product-name"><?=$row['attribute_title']?></a> 
                                                            <br>
                                                            <span class="text-muted font-13"><?=$row['description']?></span> 
                                                        </p>
                                                    </td>
													<td><?=givedata($conn,"attribute_type","id",$row['attribute_type_id'],"attribute_type_title");?></td>
